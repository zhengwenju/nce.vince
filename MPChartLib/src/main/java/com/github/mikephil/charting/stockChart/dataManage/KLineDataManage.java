...
//                    klineDatamodel.setDateMills(data.optJSONArray(i).optLong(0, 0L));
                    ...
                    double fiveMa = get5Ma(data);
                    double tenMa = get10Ma(data);
                    double tweentyMa = get20Ma(data);
                    System.out.println("ma value:"+fiveMa+"_"+tenMa+"_"+tweentyMa);
                    klineDatamodel.setMa5(fiveMa);
                    klineDatamodel.setMa10(tenMa);
                    klineDatamodel.setMa20(tweentyMa);
...
//                    klineDatamodel.setPreClose(data.optJSONArray(i).optDouble(12));
    ...
    private double get5Ma(JSONArray data){
        double total=0;
//        for (int i = 0; i < 5; i++) {
//            double d =data.optJSONArray(i).optDouble(4);
//            total+=d;
//        }
    ...
    private double get10Ma(JSONArray data){
        double total=0;
        int length=data.length();
    ...
    private double get20Ma(JSONArray data){
        double total=0;
        int length=data.length();
        for (int i = length - 1; i >= length - 20 && i >= 0; i--){
            double d =data.optJSONArray(i).optDouble(4);
            total+=d;
        }
        return total/20;
