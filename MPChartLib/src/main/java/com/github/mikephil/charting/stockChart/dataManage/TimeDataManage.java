...
//                    timeDatamodel.setVolume(Double.valueOf(data.optJSONArray(i).optString(5)).intValue());
     ...
     * @return
     */
    public SparseArray<String> getOneDayXLabels(boolean landscape,ArrayList<String> datas) {
        ...
        if (assetId.endsWith(".HK")) {
            ...
            xLabels.put(0, String.valueOf(hour-3)+":30");
            xLabels.put(60, String.valueOf(hour-2)+":30");
            xLabels.put(120, String.valueOf(hour-1)+":30");
            xLabels.put(180, String.valueOf(hour)+":30");
            xLabels.put(240, String.valueOf(hour+1)+":30");
        }
        return xLabels;
    }
