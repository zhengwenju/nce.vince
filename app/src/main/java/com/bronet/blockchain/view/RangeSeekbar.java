...
public class RangeSeekbar extends View {
    ...
    private static final float PADDING_BOTTOM = 2f;
...
//    private Drawable mLeftCursorBG;
    ...
    public void setListener(OnCursorChangeListener mListener) {
    ...
    public void setArray(CharSequence[] mTextArray){
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mSeekbarRect.right = widthSize - mPaddingRect.right - mCursorH / 1f;
        mSeekbarRect.top = mTextDrawBottom + mMarkSize;// + mGap;
...
//            mLeftCursorBG = context.getResources().getDrawable(R.mipmap.range_seek_bar_cursor_bg);
        ...
        mTextColorNormal = a.getColor(R.styleable.RangeSeekbar_textColorNormal, Color.parseColor("#FF5E9FDF"));
        mTextColorSelected = a.getColor(R.styleable.RangeSeekbar_textColorSelected, Color.parseColor("#FF5E9FDF"));
        mSeekbarColorSelected = a.getColor(R.styleable.RangeSeekbar_seekbarColorSelected, Color.parseColor("#FF5E9FDF"));
...
//                mRightCursorIndex = 9;
//            }
            L.test("2mRightCursorIndex============>>>" + mRightCursorIndex);
...
//            mLeftCursorBG.setState(mUnPresseEanabledState);
        ...
        L.test("mRightCursorIndex=======>>>" + mRightCursorIndex);
   ...
   /* public void setValue(float value, float rang) {
        float eth = value / rang;
        if (eth < 1) {
            mRightCursorIndex = eth;
        }
        if (eth > 1) {
            mRightCursorIndex = eth/10+1;
        }
        if(mRightCursorIndex>6){
            mRightCursorIndex=6;
        }
        invalidate();
    }*/
