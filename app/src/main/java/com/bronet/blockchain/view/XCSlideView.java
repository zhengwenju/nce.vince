...
import com.bronet.blockchain.util.DensityUtil;
...
public class XCSlideView extends RelativeLayout{
    ...
    private void attachToContentView(Activity activity, Positon positon) {
        ...
        mMaskView.setBackgroundColor(mContext.getResources().getColor(R.color.black1));
     ...
     * 设置侧滑菜单View的宽度
     */
    public void setMenuHight(int hight) {
        ViewGroup.LayoutParams params = this.getLayoutParams();
        params.height = hight;
        mMenuWidth = hight;
        this.setLayoutParams(params);
