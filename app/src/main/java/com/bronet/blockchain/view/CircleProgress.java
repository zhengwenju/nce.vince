...
import com.bronet.blockchain.util.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private int[] mGradientColors = {getResources().getColor(R.color.blue2),getResources().getColor(R.color.blue3),getResources().getColor(R.color.blue3)};
    //当前进度，[0.0f,1.0f]
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mHintColor = typedArray.getColor(R.styleable.CircleProgressBar_hintColor, Color.green(R.color.blue2));
        ...
        mValueColor = typedArray.getColor(R.styleable.CircleProgressBar_valueColor,getResources().getColor(R.color.blue2));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mValueOffset =mCenterPoint.y - mRadius * mTextOffsetPercentInRadius/2 + getBaselineOffsetFromY(mHintPaint);
