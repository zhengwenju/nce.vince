...
public class HomeAdapter extends BaseQuickAdapter< GetH24List.Data ,BaseViewHolder> {
    public HomeAdapter(@LayoutRes int layoutResId, @Nullable List< GetH24List.Data> data) {
    ...
    protected void convert(BaseViewHolder helper,  GetH24List.Data item) {
        ...
        Glide.with(mContext).load(item.getImgUrl()).into((ImageView)helper.getView(R.id.image));
