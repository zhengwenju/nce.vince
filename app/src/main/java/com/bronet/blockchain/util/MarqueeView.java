...
public class MarqueeView extends ViewFlipper {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.sunfusheng.marqueeview.R.styleable.MarqueeViewStyle, defStyleAttr, 0);

        interval = typedArray.getInteger(com.sunfusheng.marqueeview.R.styleable.MarqueeViewStyle_mvInterval, interval);
        hasSetAnimDuration = typedArray.hasValue(com.sunfusheng.marqueeview.R.styleable.MarqueeViewStyle_mvAnimDuration);
        ...
        int gravityType = typedArray.getInt(com.sunfusheng.marqueeview.R.styleable.MarqueeViewStyle_mvGravity, GRAVITY_LEFT);
        switch (gravityType) {
            case GRAVITY_LEFT:
        ...
        hasSetDirection = typedArray.hasValue(com.sunfusheng.marqueeview.R.styleable.MarqueeViewStyle_mvDirection);
        direction = typedArray.getInt(com.sunfusheng.marqueeview.R.styleable.MarqueeViewStyle_mvDirection, direction);
        if (hasSetDirection) {
            switch (direction) {
    ...
    private TextView createTextView(CharSequence text) {
        ...
        if (textView == null) {
            ...
            textView.setTextColor(Color.parseColor("#FFE81825"));
